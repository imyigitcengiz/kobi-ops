...
MODULES: tuple[dict, ...] = (
    ...
    {
        'slug': 'agency_retainer',
        'kind': MODULE_KIND_APP,
        'name': 'Retainer Stüdyosu',
        'summary': 'Ajans retainer projeleri ve MRR özeti.',
    ...
    },
    {
        'slug': 'agency_clients',
        'kind': MODULE_KIND_APP,
        'name': 'Ajans Müşteri & Marka',
        'summary': 'Ajans müşteri kartları — KOBİ rehberinden bağımsız.',
        'access_perm': 'access.agency',
        ...
        'status': MODULE_STATUS_ACTIVE,
        'panel_section': None,
        'route_prefixes': ('/ajans/musteriler/',),
        'particle_slugs': (),
        'sort': 16,
        'default_enabled': True,
        'can_disable': True,
    ...
    {
        'slug': 'agency_freelancers',
        'kind': MODULE_KIND_APP,
        'name': 'Freelancer Ağı',
        'summary': 'Taşeron ve uzman freelancer kadrosu.',
        'access_perm': 'access.agency',
        ...
        'status': MODULE_STATUS_ACTIVE,
        'panel_section': None,
        'route_prefixes': ('/ajans/freelancer/',),
        'particle_slugs': (),
        'sort': 17,
        'default_enabled': True,
        'can_disable': True,
    ...
    {
        'slug': 'agency_pipeline',
        'kind': MODULE_KIND_APP,
        'name': 'Proje Pipeline',
        'summary': 'Teklif ve proje satış takibi.',
        'access_perm': 'access.agency',
    ...
    {
        'slug': 'agency_campaigns',
        'kind': MODULE_KIND_APP,
        'name': 'Ajans Kampanyaları',
        'summary': 'Müşteri kampanya taslakları.',
        'access_perm': 'access.agency',
